            ...
            <div className='flex flex-col justify-between mt-5 lg:flex lg:flex-row'>
                <div className='ms-3'>
                    ...
                    <ul className='text-start text-[17px]'>
                        <li className='mt-2 '>  1. Search by name or directly paste the link of video you want to <br /> convert </li>
                        <li className='mt-2 '> 2. Click "Start" button to begin converting process </li>
                        <li className='mt-2 '>  3. Select the video/audio format you want to download, then click <br /> "Download" button </li>
                    </ul>
                </div>
                <div className='ms-3 mt-3'>
                    <h4 className='text-xl font-semibold text-start'> Features</h4>
                    <ul className='text-start text-[17px]'>
                        <li className='mt-2 '> • Unlimited downloads and always free </li>
                        <li className='mt-2 '> • High-speed video converter </li>
                        <li className='mt-2 '>  • No registration requirement </li>
                        <li className='mt-2 '>  • Support downloading with all formats </li>
                    </ul>
                </div>
            </div>
            <hr className='mt-5 mb-5' />

            <div className='mt-4 ms-3 me-3 items-center'>
                <h3 className='text-2xl font-bold'>Online YouTube Video Downloader</h3>
                <p className='text-[16px] mt-2 text-center'>Y2meta.app allows you to convert & download video from YouTube, Facebook, Video, Dailymotion, Youku, etc. to Mp3, Mp4 in HD. Y2meta supports downloading all video formats such as: MP4, M4V, 3GP, WMV, FLV, MO, MP3, WEBM, etc. You can easily download for free thousands of videos from YouTube and other websites.</p>
            </div>

            <hr className='mt-5 mb-5' />

            <div className='flex flex-col items-center lg:flex lg:flex-row mt-2'>
